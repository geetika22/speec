...
import VicePresidentCard from "./VicePresidentNomineeCard";
...
const PresidentSection = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/admin/vicepresidentdata")
      .then((res) => {
        setPosts(res.data);
      })
      .catch((err) => {
  ...
  return (
    ...
    <ScrolltoTop />
      ...
      <Container>
        ...
        <Row>
          <Col xs={12}>
            <CategoryTitle className="heading">Vice President Section</CategoryTitle>
            <CategorySubheading className="para2">
              Welcome to Computer Science and Engineering Department <br />
              Here are the different candidates that stood for the Vice President
              Post...
              <br />
              <b>
        ...
        <Row>
          <Col lg={6}>
            <VicePresidentCard {...posts[0]} />
          </Col>
          <Col lg={6}>
            <VicePresidentCard {...posts[1]} />
          </Col>
        </Row>
        <Row>
          <Col lg={6}>
            <VicePresidentCard {...posts[2]} />
          </Col>
          <Col lg={6}>
            <VicePresidentCard {...posts[3]} />
          </Col>
        </Row>
      </Container>
      <FooterSection />
