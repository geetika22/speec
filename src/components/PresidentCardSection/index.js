...
import { NomineeContainer } from "./NomineeCardElements";
import NomineeCard from "../NomineeCardComponent";
...
const PresidentSection = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/admin/presidentdata")
      .then((res) => {
        setPosts(res.data);
      })
      .catch((err) => {
  ...
  return (
    <>
      ...
      <NomineeContainer>
        ...
        <Row>
          <Col xs={12}>
            <CategoryTitle className="heading">President Section</CategoryTitle>
            <CategorySubheading className="para2">
              Welcome to Computer Science and Engineering Department <br />
              Here are the different candidates that stood for the President
              Post...
              <br />
              <b>
